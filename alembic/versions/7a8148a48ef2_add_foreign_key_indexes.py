...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_recipe_components_recipe_id"),
        "recipe_components",
        ["recipe_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recipe_ingredients_component_id"),
        "recipe_ingredients",
        ["component_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_comments_recipe_id"), "comments", ["recipe_id"], unique=False
    )
    op.create_index(op.f("ix_comments_user_id"), "comments", ["user_id"], unique=False)

    # RecipeDiet foreign keys
    op.create_index(
        op.f("ix_recipe_diets_recipe_id"), "recipe_diets", ["recipe_id"], unique=False
    )

    # MealTemplate foreign keys
    op.create_index(
        op.f("ix_meal_templates_user_id"), "meal_templates", ["user_id"], unique=False
    )

    # MealTemplateSlot foreign keys
    op.create_index(
        op.f("ix_meal_template_slots_template_id"),
        "meal_template_slots",
        ["template_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_meal_template_slots_recipe_id"),
        "meal_template_slots",
        ["recipe_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_meals_template_id"), "meals", ["template_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_meal_items_slot_id"), "meal_items", ["slot_id"], unique=False
    )
    op.create_index(
        op.f("ix_meal_items_recipe_id"), "meal_items", ["recipe_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    # MealTemplateSlot foreign keys
    op.drop_index(
        op.f("ix_meal_template_slots_recipe_id"), table_name="meal_template_slots"
    )
    op.drop_index(
        op.f("ix_meal_template_slots_template_id"), table_name="meal_template_slots"
    )
    ...
    op.drop_index(
        op.f("ix_recipe_ingredients_component_id"), table_name="recipe_ingredients"
    )

    # RecipeComponent foreign keys
    op.drop_index(
        op.f("ix_recipe_components_recipe_id"), table_name="recipe_components"
    )
