...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_recipes_yield_amount'), 'recipes', ['yield_amount'], unique=False)
    op.create_index(op.f('ix_recipes_calories'), 'recipes', ['calories'], unique=False)
    op.create_index(op.f('ix_recipes_total_time_minutes'), 'recipes', ['total_time_minutes'], unique=False)
