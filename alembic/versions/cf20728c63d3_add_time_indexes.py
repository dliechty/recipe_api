...
def upgrade() -> None:
    """Upgrade schema."""
    op.create_index(op.f('ix_recipes_active_time_minutes'), 'recipes', ['active_time_minutes'], unique=False)
    op.create_index(op.f('ix_recipes_cook_time_minutes'), 'recipes', ['cook_time_minutes'], unique=False)
    op.create_index(op.f('ix_recipes_prep_time_minutes'), 'recipes', ['prep_time_minutes'], unique=False)
