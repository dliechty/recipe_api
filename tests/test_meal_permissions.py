...
def test_admin_can_update_other_user_template(client: TestClient, db: Session):
    """Admin can update another user's template."""
...
def test_admin_can_delete_other_user_template(client: TestClient, db: Session):
    """Admin can delete another user's template."""
...
def test_any_user_can_read_meal_list(client: TestClient, db: Session):
    """Any authenticated user can list all meals."""
...
def test_any_user_can_read_single_meal(client: TestClient, db: Session):
    """Any authenticated user can read a specific meal by ID."""
...
def test_admin_can_update_other_user_meal(client: TestClient, db: Session):
    """Admin can update another user's meal."""
...
def test_admin_can_delete_other_user_meal(client: TestClient, db: Session):
    """Admin can delete another user's meal."""
